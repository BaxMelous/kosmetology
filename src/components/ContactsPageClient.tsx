                ...
                <div className="grid grid-cols-[40px_1fr] items-start gap-x-3 gap-y-2">
                  ...
                  <div className="col-start-2">
                    <a
                      ...
                      className="text-base font-medium text-slate-800 transition-colors hover:text-orange-500 md:text-lg"
                    >
                      {CONTACTS.phone}
                    </a>
                    <p className="mt-2 text-sm text-slate-500">{CONTACTS.workingHours.weekdays}</p>
                    <p className="text-sm text-slate-500">{CONTACTS.workingHours.saturday}</p>
                    <p className="text-sm text-slate-500">{CONTACTS.workingHours.sunday}</p>
                  </div>
                </div>
              </div>
            </div>
