      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-8 lg:px-12 xl:px-16">
        <div className="mb-10 flex flex-col justify-between gap-4 md:mb-16 md:flex-row md:items-end md:gap-6">
          <div className="space-y-4">
            <h2 className="text-xl font-light tracking-[0.08em] text-[#1a1a2e] sm:text-2xl md:text-3xl">Наши услуги</h2>
            <p className="text-slate-500 max-w-xl">
              Передовые методики для вашей красоты. Мы используем только сертифицированные препараты и оборудование.
            </p>
          </div>
          <Link href="/prices" className="group flex items-center font-medium text-primary transition-all duration-300 hover:text-primary-hover focus-visible:ring-2 focus-visible:ring-primary/50 rounded-lg">
            Весь прайс-лист
        ...
        <div className="grid grid-cols-1 gap-4 md:gap-8 lg:grid-cols-3">
          {SERVICE_CATEGORIES.map((category) => {
            ...
            return (
              <Card key={category.id} className="group overflow-hidden rounded-card border border-slate-100 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
                ...
                <CardContent className="p-6 pt-0 md:p-8 md:pt-0">
                  ...
                  <Link href="/prices" className="mt-8 inline-flex items-center text-sm font-medium text-slate-700 transition-all duration-300 hover:text-primary">
                    Подробнее
