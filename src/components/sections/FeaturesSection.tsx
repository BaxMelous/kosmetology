    ...
    <section className="bg-white py-28">
      <div className="container mx-auto max-w-7xl px-4 md:px-8">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-3xl font-semibold text-slate-800 md:text-5xl">Почему выбирают нас</h2>
          <p className="text-slate-500 max-w-2xl mx-auto">
            Мы объединили медицинскую точность с эстетическим видением, чтобы дарить вам уверенность в себе.
          </p>
        </div>
