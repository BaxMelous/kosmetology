      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-8 lg:px-12 xl:px-16">
        ...
        <div className="relative px-0 md:px-14">
          ...
          >
              ...
              {services.map((service, index) => (
                <CarouselItem key={index} className="basis-full pl-4 md:basis-1/2 lg:basis-1/3">
                  <div className="flex h-full px-1 pb-1 pt-3">
                    <article className="group flex w-full flex-col overflow-hidden rounded-card border border-slate-100 bg-white transition-all duration-500 hover:-translate-y-1">
                      ...
                      <div className="flex flex-1 flex-col p-8 md:p-10">
                        ...
                        <div className="mt-auto flex items-center justify-between gap-3 pt-8 md:pt-10">
                          <span className="shrink-0 whitespace-nowrap text-xl font-light tracking-[0.03em] text-[#1a1a2e] md:text-2xl">
                            {service.price}
                          </span>
                          <Button
            ...
            <CarouselPrevious className="absolute -left-1 top-1/2 flex h-9 w-9 -translate-y-1/2 rounded-full border border-slate-200 bg-white/80 text-slate-400 backdrop-blur-sm transition-all duration-300 hover:border-[#F97316]/40 hover:bg-white hover:text-[#F97316] focus-visible:ring-2 focus-visible:ring-primary/50 md:-left-6 md:h-11 md:w-11" />
            <CarouselNext className="absolute -right-1 top-1/2 flex h-9 w-9 -translate-y-1/2 rounded-full border border-slate-200 bg-white/80 text-slate-400 backdrop-blur-sm transition-all duration-300 hover:border-[#F97316]/40 hover:bg-white hover:text-[#F97316] focus-visible:ring-2 focus-visible:ring-primary/50 md:-right-6 md:h-11 md:w-11" />
          </Carousel>
        </div>
      </div>
    </section>
