    ...
    <section id="doctors" className="py-10 md:py-28">
      <div className="container mx-auto max-w-7xl px-4 md:px-8 lg:px-12 xl:px-16">
        <div className="mb-10 flex flex-col justify-between gap-4 md:mb-16 md:flex-row md:items-center md:gap-6">
          ...
          <Link
            href="/doctors"
            className="group inline-flex items-center justify-center font-medium text-primary transition-all duration-300 hover:text-primary-hover md:justify-start"
          >
            Все специалисты
