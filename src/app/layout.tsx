...
export const metadata: Metadata = {
  ...
  description: "Центр косметологии СитиМед Эстетика в Йошкар-Оле на Ленинском проспекте, ул. Лобачевского, 1. SMAS-лифтинг, контурная пластика, биоревитализация, ботулинотерапия от морщин, чистка лица, аппаратная коррекция фигуры. Запись: +7 (927) 684-54-54.",
  keywords: ["косметология йошкар-ола", "ситимед эстетика", "smas-лифтинг", "чистка лица", "контурная пластика", "аппаратная косметология", "косметология ленинский проспект", "ботулинотерапия", "убрать морщины", "липолитики", "полимолочная кислота", "экзосомы"],
  alternates: {
    canonical: "https://kosmetolog-citymed.ru",
  },
  openGraph: {
    title: "СитиМед Эстетика — косметология в Йошкар-Оле на Ленинском проспекте",
