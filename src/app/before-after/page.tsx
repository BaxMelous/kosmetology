    ...
    <div className="bg-slate-50 pb-10 md:pb-20">
      ...
      <ScrollReveal>
        <section className="container mx-auto max-w-7xl px-4 pt-6 md:px-8 md:pt-10">
          {/* Disclaimer */}
          <div className="mx-auto mb-12 max-w-3xl rounded-2xl border border-[#FF5607]/15 bg-white/40 px-5 py-3.5 text-center text-[13px] font-light leading-relaxed text-slate-500 backdrop-blur-sm md:mb-16 md:px-6 md:py-4">
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-12 lg:gap-16">
            {BEFORE_AFTER_CASES.map((caseItem, index) => (
              <ScrollReveal key={caseItem.id} delayMs={index * 60} className="h-full">
                <article className="group flex h-full flex-col overflow-hidden rounded-[2rem] border border-slate-100 bg-white shadow-[0_15px_35px_rgba(0,0,0,0.03)] transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_25px_50px_rgba(0,0,0,0.06)]">
                  {/* Slider */}
                  <BeforeAfterSlider
                  ...
                  <div className="flex flex-1 flex-col space-y-3 p-6 md:p-7">
                    ...
                    <p className="text-sm font-light leading-relaxed text-[#888]">
