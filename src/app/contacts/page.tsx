              ...
              <AccordionItem value="car" className="overflow-hidden rounded-card-sm border border-slate-100 bg-white px-5 md:rounded-card md:px-7">
                ...
                <AccordionContent className="pb-5 pl-0 text-sm font-light leading-relaxed text-muted-light md:pb-8 md:pl-14 md:text-base">
                  <div className="space-y-5">
                    <p>Мы находимся в центре Йошкар-Олы по адресу: ул. Лобачевского, д. 1 (вход со стороны парковки). Для пациентов клиники предусмотрена бесплатная парковка на прилегающей территории.</p>
                    <div>
                      <p className="mb-2 font-medium text-[#1a1a2e]">Со стороны Ленинского проспекта:</p>
                      <p>Двигайтесь по Ленинскому проспекту в сторону ул. Лобачевского. Поверните на ул. Лобачевского и следуйте до дома № 1. Въезд на парковку по левой стороне — вы увидите здание с вывеской «СитиМед».</p>
                    </div>
                    <div>
                      <p className="mb-2 font-medium text-[#1a1a2e]">Со стороны улицы Зарубина:</p>
                      <p>Двигайтесь по ул. Зарубина в сторону пересечения с ул. Лобачевского. Поверните на ул. Лобачевского и следуйте до дома № 1. Заезд на парковку будет по правой стороне.</p>
                    </div>
                  </div>
                </AccordionContent>
              </AccordionItem>
