  ...
  return (
    <main className="bg-slate-50">
      <section className="container mx-auto max-w-4xl px-4 py-20 text-center md:px-8 md:py-32">
        <div className="rounded-card bg-white p-8 shadow-sm md:p-12">
          ...
          <Link
            href="/doctors"
            className="mt-8 inline-flex items-center rounded-xl bg-primary px-6 py-3 font-medium text-white transition-colors hover:bg-primary-hover"
          >
